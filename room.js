...
class RoomSystem {
    ...
    setupEventListeners() {
        // Sichere Prüfung ob Game und Canvas existieren
        if (!window.game || !window.game.canvas) {
            console.log('Room System: Game oder Canvas noch nicht verfügbar, verzögere Setup...');
            setTimeout(() => this.setupEventListeners(), 100);
            return;
        }
        
        const canvas = window.game.canvas;
        console.log('Room System: Event Listeners für Canvas eingerichtet');
